...
ol_lib = projects_dirs.build_dir + '/applications/OpLink/core-lib/liboplink-core-qt6-0.0.0.so'
pf.install_pf_lib(root_install_dir,ol_lib)

# for backend bundles only
ol_backend_lib = projects_dirs.build_dir + '/applications/OpLink/core-backend-lib/liboplink-core-backend-qt6-0.0.0.so'
...
# console
#--------
ol_console = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/console/plugin/liboplinkB-console-qt6-0.0.0.so'
pf.install_pf_bundle(backend_install_dir,'console',ol_console)

# users
#------
pf_users = projects_dirs.build_dir + '/plugframe/bundles/users/plugin/libusers-qt6-1.0.0.so'
...
# engine
#-------
ol_engine = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/engine/plugin/liboplinkB-engine-qt6-0.0.0.so'
pf.install_pf_bundle(backend_install_dir,'engine',ol_engine)

# enoceaninfrastructure
#----------------------
ol_enoceaninfrastructure = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/enoceaninfrastructure/plugin/liboplinkB-enoceaninfrastructure-qt6-0.0.0.so'
...
# heatingmanagerset
#------------------
ol_heatingmanagerset = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/heatingmanagerset/plugin/liboplinkB-heatingmanagerset-qt6-0.0.0.so'
...
#---------------
ol_modelloader = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/observablemodelloader/plugin/liboplinkB-observablemodelloader-qt6-0.0.0.so'
...
#------------------------
ol_observablemodelregister = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/observablemodelregister/plugin/liboplinkB-observablemodelregister-qt6-0.0.0.so'
...
#-----------
ol_tcpbackend = projects_dirs.build_dir + '/applications/OpLink/backend-bundles/tcpbackend/plugin/liboplinkB-tcpbackend-qt6-0.0.0.so'
...
# OpLink GuiConsole
#------------------
ol_guiconsole = projects_dirs.build_dir + '/applications/OpLink/frontend-bundles/guiconsole/plugin/liboplinkF-guiconsole-qt6-0.0.0.so'
...
# tcpfrontend
#-----------
ol_tcpfrontend = projects_dirs.build_dir + '/applications/OpLink/frontend-bundles/tcpfrontend/plugin/liboplinkF-tcpfrontend-qt6-0.0.0.so'
