...
namespace oplink
{
class OLCORE_BACKEND_LIB_EXPORT StateToWatchList : public QList<QspStateToWatch>
{
public:
    StateToWatchList();
    virtual ~StateToWatchList();

public:
    bool allTrue();
};
using QspStateToWatchList = QSharedPointer<StateToWatchList>;
}//namespace oplink
