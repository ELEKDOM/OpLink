...
HeatingManagerPwtWidgetCtrl::HeatingManagerPwtWidgetCtrl(QString observableName,
    ...
    HeatingManagerWidgetCtrl{observableName,
                             observableTitle,
                             oplink::HeatingManagerModelNames::pilotWireThermostatModelName(),
                             observableLocalisation}
{
    extractSchedulerFlagAndNumberOfRooms(oplink::HeatingManagerModelNames::pilotWireThermostatModelName(),observableType);
}
