...
SensorPropertyModel::SensorPropertyModel(const PropertyModelName& modelName,
...
SensorPropertyModel::~SensorPropertyModel()
{

}

observable::Property *SensorPropertyModel::createProperty(observable::Observable& observable)
{
