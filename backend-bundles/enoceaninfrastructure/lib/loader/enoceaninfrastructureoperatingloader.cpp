...
EnoceanInfrastructureOperatingLoader::~EnoceanInfrastructureOperatingLoader()
{
...
EnoceanGatewayMode *EnoceanInfrastructureOperatingLoader::createGatewayMode()
{
    return new EnoceanOperatingGateway;
}
