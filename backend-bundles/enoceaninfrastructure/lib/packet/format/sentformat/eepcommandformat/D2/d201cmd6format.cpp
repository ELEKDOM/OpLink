...
D201Cmd6Format::D201Cmd6Format(bool queryEnergy):
    ...
    m_queryEnergy{queryEnergy}
{

}

D201Cmd6Format::~D201Cmd6Format()
{

}

void D201Cmd6Format::fillInData()
{
    ...
    if (m_queryEnergy)
    {
        // Ask all output channel for Energy
        packet->populateData(2, 0x1E);
    }
    else
    {
        // Ask all output channel for Power
        packet->populateData(2, 0x3E);
    }
}
