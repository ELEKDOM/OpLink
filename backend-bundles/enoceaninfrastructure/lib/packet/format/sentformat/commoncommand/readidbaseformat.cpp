...
QspResponseFormat ReadIdBaseFormat::getExpectedResponseFormat(const QspEsp3Packet &responsePacket)
{
    QspResponseFormat ret{new ReadIdBaseResponseFormat{responsePacket}};
